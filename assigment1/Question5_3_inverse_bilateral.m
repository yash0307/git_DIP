...
% Inverse Bileteral filter is used for 'Saliency' ref="http://research.ijcaonline.org/volume118/number10/pxc3903343.pdf" %
%
% Window size = 5
% 
% This is implementation of inverse Bilateral Filter for a gray scale image %
% 
% Approach Used :
...
%
% Thus : Pixels with huge variations -> More effect of Gaussian Filter.
%        Pixels with less variations -> Less effect of Gaussian Filter.
%
